...
- choose Chinese typefaces by visual world, not by one default. Classical, elegant, ceremonial, literary, museum, opera, baroque, romantic, or heritage directions should usually use a serif/songti stack such as `"Songti SC"`, `"Noto Serif CJK SC"`, `"Source Han Serif SC"`, `"STSong"`, `"SimSun"`, serif. Modern, Swiss, cyber, sporty, product, UI-like, street, or technical directions should usually use a sans stack such as `"Microsoft YaHei"`, `"PingFang SC"`, `"Noto Sans CJK SC"`, `"Source Han Sans SC"`, sans-serif.
- for Chinese display type, prefer high-quality CJK fonts and always match the typeface category to the concept. Do not let `Arial Black`, `Impact`, or generic Latin headline fonts drive Chinese typography.
